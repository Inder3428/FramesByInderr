...
import { Camera, Users, Building, Palette, Video, Award, Globe, Sparkles, ArrowRight, ChevronDown } from 'lucide-react';
import * as THREE from 'three';

// ============================================================================
// StarBorder Component - Animated border effect with star movement animation
// ============================================================================
  ...
  return (
    <>
      ...
      <Component 
        ...
        {...props}
      >
        {/* Bottom star movement animation */}
        <div
...
const Home = () => {
  ...
  // ============================================================================
  // Three.js Setup for Contact Section Background
  // Creates an animated dotted grid pattern with wave effects
  // ============================================================================
  useEffect(() => {
    ...
    // Create buffer geometry for particle system
    ...
    // Animation loop - creates wave effect on points
    const animate = () => {
      ...
      for (let ix = 0; ix < AMOUNTX; ix++) {
        for (let iy = 0; iy < AMOUNTY; iy++) {
          ...
          // Apply wave animation using sine functions
          positions[index + 1] =
  ...
  // ============================================================================
  // Auto-scrolling Showcase Effect
  // ============================================================================
  useEffect(() => {
    ...
    <div ref={containerRef} className="min-h-screen bg-black text-white overflow-x-hidden">
      <style>{`
        ...
        * {
        ...
        /* Showcase auto-scroll animation */
        .showcase-track {
        ...
        >
          ...
          {[...Array(5)].map((_, i) => (
            <motion.div
              ...
              initial={{ x: Math.random() * (typeof window !== 'undefined' ? window.innerWidth : 1920), y: typeof window !== 'undefined' ? window.innerHeight : 1080 }}
              animate={{
                y: -100,
          ...
          <div className="text-center space-y-8 pointer-events-auto">
            ...
            <motion.button
              ...
              className="mt-12 px-10 py-4 border border-white/20 text-xs tracking-[0.3em] 
                       transition-all duration-500 font-light backdrop-blur-sm cursor-pointer"
            >
              EXPLORE PORTFOLIO
            </motion.button>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="glass-card border border-white/10 rounded-2xl p-8 
                  ...
                  {/* Service icon with rotation on hover */}
                  <motion.div
                  ...
                  <button 
                    className="flex items-center gap-2 text-xs tracking-[0.2em] text-gray-400 
                               group-hover:text-white transition-colors duration-500 font-light cursor-pointer
                               hover:no-underline"
      ...
      {/* ====================================================================== */}
      {/* Auto-scrolling Showcase Section */}
      {/* ====================================================================== */}
          ...
          <div className="showcase-track flex gap-8">
            {[...showcaseImages, ...showcaseImages].map((image, index) => (
              <motion.div
                ...
                className="flex-none w-[400px] h-[500px] relative overflow-hidden rounded-xl cursor-pointer"
      ...
      <section className="py-32 px-6 relative bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Instagram grid - 2x3 on mobile, 3x4 on desktop */}
          ...
          >
            <motion.button
              ...
              className="px-8 py-3 border border-white/20 text-xs tracking-[0.3em] 
                       hover:bg-white hover:text-black transition-all duration-500 font-light cursor-pointer"
            >
              FOLLOW ON INSTAGRAM
            </motion.button>
          </motion.div>
      ...
      {/* ====================================================================== */}
      {/* Contact Section with Animated Dotted Background */}
      {/* ====================================================================== */}
      <section 
        id="contact"
